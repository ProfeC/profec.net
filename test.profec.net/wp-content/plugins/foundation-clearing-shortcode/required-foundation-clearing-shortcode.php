<?php
/**
 * Plugin Name: Zurb Foundation Clearing Shortcode
 * Original Plugin URI: http://themes.required.ch/
 * Description: A [clearing] shortcode plugin for the Zurb Foundation themes.
 * Version: 0.0.1
 * Original Author: required+ Team
 * Author: ProfeC
 * Origian Author URI: http://required.ch
 * Author URI: http://profec.net
 *
    ...
    public function do_shortcode( $attr ) {
        ...
        switch ( $columns ) {
            case 1:
                ...
                break;
            case 2:
                $column_classes = 'small-block-grid-2 large-block-grid-2';
                break;
            case 4:
                $column_classes = 'small-block-grid-2 large-block-grid-4';
                break;
            case 5:
                $column_classes = 'small-block-grid-2 large-block-grid-5';
                break;
            case 6:
                $column_classes = 'small-block-grid-2 large-block-grid-6';
                break;
            case 3:
            default:
                $column_classes = 'small-block-grid-2 large-block-grid-3';
                break;
        }
        ...
        $output = '<div class="req-clearing-container"><ul class="clearing-thumbs ' . $column_classes . $fearued_class . '" data-clearing>';
