...
function required_starter_themesetup() {
	...
	load_child_theme_textdomain( 'pnetPhotos', get_template_directory() . '/languages' );

	// Register an additional Menu Location
	register_nav_menus( array(
		'meta' => __( 'Meta Menu', 'pnetPhotos' )
	) );
...
function required_continue_reading_link() {
	return ' <a class="read-more" href="'. esc_url( get_permalink() ) . '">' . __( ' Read on! &rarr;', 'pnetPhotos' ) . '</a>';
}
